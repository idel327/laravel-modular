...
class MakeFieldCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'make:module:nova-field     
        {slug : The slug of the module.}
        {name : The name of the nova field class.}';
     ...
     * @var string
     */
    protected $description = 'Create a new module nova field class.';
    ...
    public function handle()
    {
        ...
        $this->info("Nova field $studlyName has been created!");
    ...
    {
        return [
            ['name', InputArgument::REQUIRED, 'Nova field name'],
